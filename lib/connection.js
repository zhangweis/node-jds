 ...
 * @param {bool} rawTxs If true, transactions won't be parsed in
 * JavaScript. This option is used for performance reasons during the
 * initial blockchain download.
 */
Connection.parseMessage = function (command, payload, noParseTxs) {
...
// DEPRECATED
["parseVarInt", "parseVarStr", "parseBlockHeader", "parseTx"]
  .forEach(function (name) {
    Connection[name] = function (parser) {
