...
Settings.prototype.setStorageDefaults = function () {
  ...
  // This is used to pass in a static block chain file to import as if
  // it were downloaded from the network. Can be a string for
  // importing a single file or an array of strings to import multiple
  // files.
  this.storage.importFrom = null;
};
